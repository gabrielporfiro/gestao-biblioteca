<x-app-layout>
    ...
    <x-container>
        <x-tabs-index
            :route="['index' => route('livro.index'), 'create' => route('livro.create')]"
            :active="'create'"
        ...
        <!-- Formulário -->
        <form action="{{ route('livro.store') }}" method="POST" enctype="multipart/form-data" class="w-full mt-4">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-12 my-2">
                    <div class="form-group">
                        ...
                        <x-text-input type="text" name="titulo" class="block mt-1 w-full" value="{{ old('titulo') }}" required autofocus />
                ...
                <div class="col-md-12 my-2">
                    <div class="form-group">
                        ...
                        <x-text-input type="text" name="codigo" class="block mt-1 w-full" value="{{ old('codigo') }}" required />
                ...
                <div class="col-md-12 my-2">
                    <div class="form-group">
                        <strong>Autor:</strong>
                        <x-text-input type="text" name="autor" class="block mt-1 w-full" value="{{ old('autor') }}" required />
                ...
                <div class="col-md-12 my-2">
                    <div class="form-group">
                        ...
                        <x-text-input type="text" name="editora" class="block mt-1 w-full" value="{{ old('editora') }}" required />
                    ...
                    <div class="form-group">
                        ...
                        <select name="categoria_livro_id" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm">
                            ...
                            @foreach ($categorias as $categoria)
                                <option value="{{ $categoria->id }}" {{ old('categoria_livro_id') == $categoria->id ? 'selected' : '' }}>
                ...
                <div class="col-md-12 my-2 text-center">
                    <button type="submit" class="btn btn-primary w-full">
                        <span data-feather="save"></span> Criar Livro
                    </button>
                </div>
            </div>
        </form>
